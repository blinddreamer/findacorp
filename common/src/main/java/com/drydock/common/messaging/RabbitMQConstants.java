package com.drydock.common.messaging;

public final class RabbitMQConstants {

    private RabbitMQConstants() {}

    public static final String ENRICHMENT_EXCHANGE   = "drydock.enrichment";
    ...
    public static final String DLX_EXCHANGE          = "drydock.enrichment.dlx";
}
