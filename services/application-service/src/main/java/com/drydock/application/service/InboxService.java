package com.drydock.application.service;

import com.drydock.application.domain.*;
import com.drydock.application.dto.*;
import com.drydock.application.feign.ProfileServiceClient;
import com.drydock.application.repository.MessageThreadRepository;
import com.drydock.application.repository.ThreadMessageRepository;
import com.drydock.application.repository.ThreadParticipantRepository;
...
public class InboxService {
    ...
    public void createCeoChangeNotification(CeoChangeNotificationRequest req) {
        ...
        String body = "Heads up — " + corpName + "'s CEO is now " + ceoName + ". "
                + "DRYDOCK syncs the roster and member join history using the CEO's access, so please ask "
                + ceoName + " to sign in to DRYDOCK to resume member sync.";
