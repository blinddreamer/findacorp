...
const CONTENT_OPTS = ['Sov', 'Small gang', 'Black ops', 'Wormhole', 'Lowsec', 'Industry', 'Capital'];
...
export default function SearchCorpsScreen() {
  ...
  const [filters, setFilters] = useState<Filters>({
    ...
    content: { 'Sov': false, 'Small gang': false, 'Black ops': true, 'Wormhole': false, 'Lowsec': true, 'Industry': false, 'Capital': false },
    spReq: 100,
