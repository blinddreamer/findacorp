...
export default function SearchPilotsScreen() {
  ...
  const [filters, setFilters] = useState<Filters>({
    ...
    content: { 'Null': false, 'Small gang': true, 'Black ops': true, 'Wormhole': false, 'Lowsec': false, 'Industry': false, 'Capital': false, 'Mining': false, 'Exploration': false, 'FW': false, 'FW Small Gang': false },
    minSP: 25,
